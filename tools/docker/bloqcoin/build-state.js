...
var OUTPUT_FILE = path.join(V86_ROOT, "images/bloqstate.bin");
...
var emulator = new V86({
    ...
    filesystem: {
        basefs: {
            url: path.join(V86_ROOT, "/images/ubuntu-bloqcoin-base-fs.json"),
        },
        baseurl: path.join(V86_ROOT, "/images/ubuntu-bloqcoin-9p-rootfs-flat/"),
    },
    screen_dummy: true,
