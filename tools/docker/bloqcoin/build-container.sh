...
OUT_ROOTFS_TAR="$IMAGES"/ubuntu-bloqcoin-9p-rootfs.tar
OUT_ROOTFS_FLAT="$IMAGES"/ubuntu-bloqcoin-9p-rootfs-flat
OUT_FSJSON="$IMAGES"/ubuntu-bloqcoin-base-fs.json
CONTAINER_NAME=ubuntu-bloqcoin
IMAGE_NAME=i386/ubuntu-bloqcoin
